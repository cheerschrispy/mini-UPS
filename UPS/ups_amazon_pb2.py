...
_UMESSAGES = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='truckReadies', full_name='UMessages.truckReadies', index=2,
...
UMessages = _reflection.GeneratedProtocolMessageType('UMessages', (_message.Message,), {
...
AMessages = _reflection.GeneratedProtocolMessageType('AMessages', (_message.Message,), {
